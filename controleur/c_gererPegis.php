	...
	switch ($action) {
		...
		case 'ajouterNouveauPegi': {
				if (!empty($_POST['txtAgePegi'])) {
					$idPegiNotif = $db->ajouterPegi($_POST['txtAgePegi'], $_POST['txtDescriptionPegi']);
		...
		case 'validerModifierPegi': {
				$db->modifierPegi($_POST['txtIdPegi'], $_POST['txtAgePegi'], $_POST['txtDescriptionPegi']);
