 ...
 */
final class Version20250227104651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournoi DROP participants, CHANGE nb_participants nb_participants INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tournoi ADD participants VARCHAR(255) DEFAULT NULL, CHANGE nb_participants nb_participants INT NOT NULL');
    }
}
