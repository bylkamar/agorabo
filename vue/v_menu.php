    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a <?php if (isset($menuActif) && $menuActif == 'Jeux') {
                  echo 'class="active"';
                } ?> href="index.php">
          ...
          <li class="sub-menu">
            <a <?php if (isset($menuActif) && $menuActif == 'Clubs') {
                  echo 'class="active"';
                } ?> href="javascript:;">
          ...
          <li class="sub-menu">
            <a <?php if (isset($menuActif) && $menuActif == 'Formations') {
                  echo 'class="active"';
                } ?> href="javascript:;">
              <i class="fa fa-th"></i>
          ...
          <li class="sub-menu">
            <a <?php if (isset($menuActif) && $menuActif == 'Membres') {
                  echo 'class="active"';
                } ?> href="javascript:;">
          ...
          <li class="sub-menu">
            <a <?php if (isset($menuActif) && $menuActif == 'Intervenants') {
                  echo 'class="active"';
                } ?> href="javascript:;">
